...
export const RESOURCE_CONFIG: Record<string, ResourceMeta> = {
  ...
  DUSTBIN: {
    key: 'DUSTBIN',
    label: 'Garbage Bin & Swachhata Point',
    shortLabel: 'Dustbin',
    color: '#059669',
    bgColor: '#ecfdf5',
    borderColor: '#6ee7b7',
    svgIcon: `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="#059669" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>`,
  },
};
